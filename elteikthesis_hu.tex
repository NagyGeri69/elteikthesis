...
% Document's metadata
\title{Kétszemélyes társasjáték applikáció} % title
...
\supervisor{Tichler Krisztián} % internal supervisor's name
\affiliation{egyetemi adjunktus} % internal supervisor's affiliation
\extsupervisor{Chhay Keokanitha} % external supervisor's name
